import{s as a,i as r,y as l,p as u,e as g,l as m,a as f}from"./indexhtml-8e105ac1.js";import{e as v}from"./custom-element-73470d87.js";function w(e){var o;const t=[];for(;e&&e.parentNode;){const i=y(e);if(i.nodeId!==-1){if((o=i.element)!=null&&o.tagName.startsWith("FLOW-CONTAINER-"))break;t.push(i)}e=e.parentElement?e.parentElement:e.parentNode.host}return t.reverse()}function y(e){const t=window.Vaadin;if(t&&t.Flow){const{clients:o}=t.Flow,i=Object.keys(o);for(const s of i){const n=o[s];if(n.getNodeId){const c=n.getNodeId(e);if(c>=0)return{nodeId:c,uiId:n.getUIId(),element:e}}}}return{nodeId:-1,uiId:-1,element:void 0}}var k=Object.defineProperty,E=Object.getOwnPropertyDescriptor,C=(e,t,o,i)=>{for(var s=i>1?void 0:i?E(t,o):t,n=e.length-1,c;n>=0;n--)(c=e[n])&&(s=(i?c(t,o,s):c(s))||s);return i&&s&&k(t,o,s),s};let p=class extends a{render(){return l`<div
      tabindex="-1"
